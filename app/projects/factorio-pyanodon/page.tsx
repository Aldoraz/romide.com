...
export default function FactorioPyanodon() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center">
      <h1 className="text-4xl font-bold mb-8">Factorio Pyanodon Progress</h1>
      ...
      <div className="mt-8 w-full px-16">
        {currentMapshot && (
          <iframe
            src={`/projects/factorio-pyanodon/mapshots/${currentMapshot.folderName}/index.html`}
